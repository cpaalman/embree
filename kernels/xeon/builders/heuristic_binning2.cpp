...
namespace embree
{
  ...
  template<int logBlockSize>
  void HeuristicBinning2<logBlockSize>::Split::split(size_t threadIndex, PrimRefAlloc* alloc, 
                                                     atomic_set<PrimRefBlock>& prims, atomic_set<PrimRefBlock>& lprims, atomic_set<PrimRefBlock>& rprims)
  {
